...
- **[CONTEXT]** After research compression, check context utilization. If >40% (Caution Zone), delegate Phase 2 planning to a subagent with fresh context. See `intentional-compaction.md` → Context Budget Awareness.
...
- **[CONTEXT]** Material generation is context-expensive. If >40% before starting Phase 3, spawn content developer subagents — do NOT generate materials in the orchestrator's context.
