...
test('formatConfigPath with claudeDir', formatConfigPath('/home/user/.claude').includes('.gkignore'));
test('formatConfigPath without claudeDir', formatConfigPath(null) === '.claude/.gkignore');
test('formatConfigPath empty string', formatConfigPath('') === '.claude/.gkignore');
