...
**Expected output:**
```
Telegram notification sent for Stop event in project khoiclaudekit-engineer
```
...
📁 Project: khoiclaudekit-engineer
🔧 Total Operations: 15
🆔 Session: abc12345...
...
📍 Location: `/Users/user/projects/khoiclaudekit-engineer`
```
