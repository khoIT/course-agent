...
function generateCardMeta(plan) {
  ...
  // Issue tag - clickable link to GitHub (uses branch to derive repo, falls back to khoiclaudekit)
  if (plan.issue) {
    // TODO: Make repo configurable via project settings
    const issueUrl = `https://gitlab.gt.vng.vn/vng-reusable-solutions/aawp/2026/aawp-ai-coding-kit/khoiclaudekit/issues/${plan.issue}`;
