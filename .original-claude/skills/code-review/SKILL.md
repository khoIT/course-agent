...
- YAGNI chekk: grep for usage before implementing "proper" features
...
|------------|-----------|---------|
| `/kk:code-review codebase` | `references/codebase-scan-workflow.md` | Scan & analyze the codebase |
| `/kk:code-review codebase parallel` | `references/parallel-review-workflow.md` | Ultrathink edge cases, then parallel verify |
