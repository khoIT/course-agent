...
Activate `kk:debug` skill. Launch 2-3 `Explore` subagents in parallel:
```
...
|------|------------------|
| 1 | `kk:debug`, parallel `Explore` subagents for investigation |
| 2 | `researcher` (runs parallel with step 1) |
| 3 | `kk:brainstorm` |
| 4 | `planner` |
| 5 | `kk:problem-solving`, `kk:sequential-thinking`, `kk:context-engineering`, parallel `Bash` |
| 6 | `tester` |
| 7 | `code-reviewer` |
| 8 | `project-manager`, `docs-manager`, `Bash` |

**Rules:** Don't skip steps. Validate before proceeding. One phase at a time.
**Frontend:** Use `chrome`, `kk:chrome-devtools` or any relevant skills/tools to verify.
