...
## Prerequisites
- Activate `kk:ui-ux-pro-max` skill first for design intelligence
- Have `kk:ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `kk:ai-multimodal` skill to extract:
...
- Remove backgrounds if needed with `kk:media-processing`
