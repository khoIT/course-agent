...
### Step 2: Summarize the plans and document them with `/kk:journal` slash command
...
- Stage and commit the changes (Use `/kk:git cm` slash command)
- Commit and push the changes (Use `/kk:git cp` slash command)
