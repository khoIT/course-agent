...
- `/kk:kanban` - View dashboard for ./plans directory
- `/kk:kanban <dir>` - View dashboard for specific directory
- `/kk:kanban --stop` - Stop running server
...
The `/kk:kanban` command will evolve into **VibeKanban-inspired** AI agent orchestration:
...
Track progress: https://gitlab.gt.vng.vn/vng-reusable-solutions/aawp/2026/aawp-ai-coding-kit/khoiclaudekit-engineer/issues/189
