...
5. Screenshot wireframes with `kk:chrome-devtools` → save to `./docs/wireframes/`
...
Activate **kk:cook** skill: `/kk:cook <plan-path>` (interactive mode — review gates at each step)
