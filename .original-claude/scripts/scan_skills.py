...
def main():
    ...
    # Output YAML to gk-help scripts directory
    output_path = Path('.claude/skills/gk-help/scripts/skills_data.yaml')
    ...
    legacy_path.write_text(
        "# Skills catalog moved to .claude/skills/gk-help/scripts/skills_data.yaml\n"
