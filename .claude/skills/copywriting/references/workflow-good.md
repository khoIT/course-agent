...
1. **Screenshots provided** → Use `kk:ai-multimodal` skill for detailed context analysis
2. **Videos provided** → Use `kk:ai-multimodal` video-analysis for comprehensive context
