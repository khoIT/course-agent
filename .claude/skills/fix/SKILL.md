...
**Always activate:** `kk:debug` (all workflows)
**Conditional:** `kk:problem-solving`, `kk:sequential-thinking`, `kk:brainstorm`, `kk:context-engineering`
...
- `references/workflow-quick.md` - Quikk: debug → fix → review
