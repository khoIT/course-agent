...
1. `kk:ui-ux-pro-max` - Design database (ALWAYS FIRST)
2. `kk:ui-ux-pro-max` - Design principles
3. `kk:frontend-design` - Implementation patterns
...
Analyze screenshots/videos with `kk:ai-multimodal` skill.
...
Screenshot + `kk:ai-multimodal` analysis.
