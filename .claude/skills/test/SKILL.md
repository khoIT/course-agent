...
Browser-based visual testing via `kk:chrome-devtools` skill. Screenshots, responsive checks, accessibility audits, form automation, console error collection. Includes auth injection for protected routes.
...
6. For frontend: run UI tests via `kk:chrome-devtools` skill
...
- **Browser**: `kk:chrome-devtools` skill for UI testing (screenshots, ARIA, console, network)
