...
- **Sync-bakk:** Reconcile all completed tasks against all phase files, update `[ ]` → `[x]`, update YAML frontmatter status
...
- `kk:cook` — Implements plans (execution phase, invokes project-manager at finalize)
