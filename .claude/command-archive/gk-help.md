---
description: KhoiClaudeKit usage guide - just type naturally
...
```bash
python .claude/scripts/gk-help.py "$ARGUMENTS"
```
...
- Use global (~/.claude/.gk.json) for personal preferences like language, issue prefix style
- Use local (./.claude/.gk.json) for project-specific paths, naming conventions
