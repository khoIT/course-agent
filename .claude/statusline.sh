...
# Calibration file path (now in /tmp/gk/ namespace - fixes #178)
CALIBRATION_PATH="${TMPDIR:-/tmp}/gk/calibration.json"
...
if command -v jq >/dev/null 2>&1; then
  ...
  # Fallbagk: Extract basic info without jq using grep/sed
