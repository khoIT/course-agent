...
describe('loadPatterns', () => {
  it('loads patterns from fixture file', () => {
    const patterns = loadPatterns(path.join(FIXTURES_DIR, 'gkignore-default.txt'));
  ...
  it('returns DEFAULT_PATTERNS for non-existent file', () => {
    const patterns = loadPatterns('/non/existent/.gkignore');
  ...
  it('loads custom patterns', () => {
    const patterns = loadPatterns(path.join(FIXTURES_DIR, 'gkignore-custom.txt'));
  ...
  it('loads negation patterns', () => {
    const patterns = loadPatterns(path.join(FIXTURES_DIR, 'gkignore-negation.txt'));
...
describe('matchPath - custom .gkignore', () => {
  const patterns = loadPatterns(path.join(FIXTURES_DIR, 'gkignore-custom.txt'));
  const matcher = createMatcher(patterns);
